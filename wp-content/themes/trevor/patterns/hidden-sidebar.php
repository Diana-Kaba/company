...
<div class="wp-block-group" style="padding-right:0;padding-left:0">
	...
	<div class="wp-block-group">
		...
		<!-- wp:navigation-link {"label":"Latest inflation report","url":"#"} /-->
		<!-- wp:navigation-link {"label":"Financial apps for families","url":"#"} /-->
		<!-- /wp:navigation -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group">
		...
		<!-- wp:search {"label":"<?php echo esc_attr_x( 'Search', 'search form label', 'trevor' ); ?>","showLabel":false,"placeholder":"<?php echo esc_attr_x( 'Search...', 'search form placeholder', 'trevor' ); ?>","width":100,"widthUnit":"%","buttonText":"<?php echo esc_attr_x( 'Search', 'search form label', 'trevor' ); ?>"} /-->
	</div>
	<!-- /wp:group -->
